...
class BarChat(QChart):
	def __init__(self,mainwindow):
		...
		self.setTitle('')
		self.names = ('<font size="5" style="color: rgb(0, 150, 0);">Норма</font>', '<font size="5" style="color: rgb(210, 210, 0);">Предупреждение</font>', '<font size="5" style="color: rgb(255, 0, 0);">Брак</font>')
...
class Statistics(QDialog):
	...
	def __init__(self):
		...
		self.datebtn1.setStyleSheet("background-color: white;"
		                                "border-width: 1;"
		                                "border-radius: 4;"
		                                "border-style: solid;"
		                                "border-color: rgb(0, 0, 0)"
		...
		self.datebtn2.setStyleSheet("background-color: white;"
		                                "border-width: 1;"
		                                "border-radius: 4;"
		                                "border-style: solid;"
		                                "border-color: rgb(0, 0, 0)"
